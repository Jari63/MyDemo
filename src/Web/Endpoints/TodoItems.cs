using MyDemo.Application.Common.Models;
using MyDemo.Application.TodoItems.Commands.CreateTodoItem;
using MyDemo.Application.TodoItems.Commands.DeleteTodoItem;
using MyDemo.Application.TodoItems.Commands.UpdateTodoItem;
using MyDemo.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MyDemo.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MyDemo.Web.Endpoints;
