...
using MyDemo.Domain.Constants;
using MyDemo.Infrastructure.Data;
using MyDemo.Infrastructure.Data.Interceptors;
...
public static class DependencyInjection
{
    public static void AddInfrastructureServices(this IHostApplicationBuilder builder)
    {
        ...
        Guard.Against.Null(connectionString, message: "Connection string 'MyDemoDb' not found.");
